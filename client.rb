...
class PlayingAround
  ...
  class User
    ...
    def self.all
      path        = PlayingAround.url + "/users.json"         # => "http://localhost:3000/users.json"
      ...
      users_array.map do |user_data|                          # => [{"id"=>2, "name"=>"Mike", "age"=>1, "url"=>"http://localhost:3000/users/2.json"}, {"id"=>3, "name"=>"Cilian", "age"=>121, "url"=>"http://localhost:3000/users/3.json"}]
        new user_data                                         # => #<PlayingAround::User:0x007fdb03b29b30 @id=2, @age=1, @name="Mike">, #<PlayingAround::User:0x007fdb03b29518 @id=3, @age=121, @name="Cilian">
      end                                                     # => [#<PlayingAround::User:0x007fdb03b29b30 @id=2, @age=1, @name="Mike">, #<PlayingAround::User:0x007fdb03b29518 @id=3, @age=121, @name="Cilian">]
    end

    def self.find(id)
      path      = PlayingAround.url + "/users/#{id}.json"                                                                 # => "http://localhost:3000/users/2.json"
      ...
      new user_hash                                                                                                       # => #<PlayingAround::User:0x007fdb03b68678 @id=2, @age=1, @name="Not Mike", @created_at=#<DateTime: 2014-03-27T17:50:26+00:00 ((2456744j,64226s,876000000n),+0s,2299161j)>, @updated_at=#<DateTime: ...
    end
...
PlayingAround.url = "http://localhost:3000"  # => "http://localhost:3000"

user = PlayingAround::User.find 2  # => #<PlayingAround::User:0x007fdb03b68678 @id=2, @age=1, @name="Not Mike", @created_at=#<DateTime: 2014-03-27T17:50:26+00:00 ((2456744j,64226s,876000000n),+0s,2299161j)>, @updated_at=#<DateTime: ...
...
PlayingAround::User.all.each do |user|  # => [#<PlayingAround::User:0x007fdb03b29b30 @id=2, @age=1, @name="Mike">, #<PlayingAround::User:0x007fdb03b29518 @id=3, @age=121, @name="Cilian">]
